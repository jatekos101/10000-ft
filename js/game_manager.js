...
((tile.value==100000)&&(next.value==200000)&&(next2.value==200000))||
((tile.value==200000)&&(next.value==100000)&&(next2.value==200000))||
((tile.value==200000)&&(next.value==200000)&&(next2.value==100000))||
...
((tile.value==50000)&&(next.value==100000)&&(next2.value==50000))||
((tile.value==500000)&&(next.value==1000000)&&(next2.value==500000)))) {
 ...
 if (merged.value > self.maxpenz) self.maxpenz=merged.value;


                    // The mighty 2048 tile
                    if (merged.value === 10000) self.won = true;
                } else if (next && next.value === tile.value && !next.mergedFrom && next.value!=20 && next.value!=200 && next.value!=2000 && next.value!=20000 && next.value!=200000 && next.value!=2000000) {
...
((tile.value==5000)&&(next.value==10000)&&(next2.value==5000)))) {
             ...
             if (next && next.value === tile.value && next.value!=20 && next.value!=200 && next.value!=2000 && next.value!=20000) {
        return true;
            }
